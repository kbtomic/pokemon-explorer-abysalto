    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 gap-y-8">
        {Array.from({ length: 20 }).map((_, index) => (
          <div key={index} className="bg-white :bg-gray-800 rounded-lg border border-red-200 p-6 animate-pulse">
            <div className="flex items-center justify-between mb-4">
              <div className="h-4 bg-red-200 rounded w-12"></div>
              <div className="h-4 bg-red-200 rounded w-16"></div>
            </div>
            <div className="flex flex-col items-center space-y-3">
              <div className="w-24 h-24 bg-red-200 rounded"></div>
              ...
              <div className="grid grid-cols-3 gap-2 w-full">
                <div className="text-center">
                  <div className="h-3 bg-red-200 rounded w-8 mx-auto mb-1"></div>
                  <div className="h-3 bg-red-200 rounded w-6 mx-auto"></div>
                </div>
                <div className="text-center">
                  <div className="h-3 bg-red-200 rounded w-8 mx-auto mb-1"></div>
                  <div className="h-3 bg-red-200 rounded w-6 mx-auto"></div>
  ...
  if (pokemonList.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">No Pokemon Found</h3>
        <p className="text-gray-600 :text-gray-400">Try adjusting your search or filters to find more Pokemon.</p>
      </div>
    );
  }
